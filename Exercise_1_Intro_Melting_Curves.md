...
## **Example Multi-Phase Melting Curve (Simulated)**

![Simulated Multi-Phase DNA Melting Curve](multi_phase_melting_curve.png)

This plot illustrates a melting profile with two distinct melting transitions,
corresponding to AT-rich and GC-rich melting domains.
